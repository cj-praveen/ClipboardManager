...
## Download
Download the latest `.app` from the [Releases](https://github.com/cj-praveen/ClipboardManager/releases) page.

### Build from Source
```
git clone https://github.com/cj-praveen/ClipboardManager.git
cd ClipboardManager
python3 -m venv .
source bin/activate
pip3 install -U pip
